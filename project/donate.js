...
const addDonation5 = () => {
  ...
  var nickel = 0.05
  var donationnew = Number(donation) + Number(nickel);
  document.querySelector('.donation').innerHTML = donationnew;
};
...
const addDonation1 = () => {
  var donation = document.querySelector('.donation').innerHTML;
  var copper = 0.01;
  var donationnew = Number(donation) + Number(copper);
  document.querySelector('.donation').innerHTML = donationnew;
};
...
const addDonation10 = () => {
  var donation = document.querySelector('.donation').innerHTML;
  var dime = 0.10;
  var donationnew = Number(donation) + Number(dime);
  document.querySelector('.donation').innerHTML = donationnew;
};
...
const addDonation25 = () => {
  var donation = document.querySelector('.donation').innerHTML;
  var quarter = 0.25;
  var donationnew = Number(donation) + Number(quarter);
  document.querySelector('.donation').innerHTML = donationnew;
};
